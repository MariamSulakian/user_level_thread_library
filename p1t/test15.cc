...
/* testing deli.cc without arguments */
...
int main(int argc, char *argv[]){
		...
		max_orders = 5;  								// arg 1: max # orders board can hold, atoi converts string to int
		numCashiers = 3;								/* arg 2: # input files, 1 input file per cashier, input file for cashier c is argv[c+2] where 0 <= c < numCashiers
